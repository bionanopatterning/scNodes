...
void main()
{
    ...
    if (rgbMode == 1.0)
    {
        ...
        float r = (rgb.r - contrastMin.r) / (contrastMax.r - contrastMin.r) * 255.0;
        float g = (rgb.g - contrastMin.g) / (contrastMax.g - contrastMin.g) * 255.0;
        float b = (rgb.b - contrastMin.b) / (contrastMax.b - contrastMin.b) * 255.0;
