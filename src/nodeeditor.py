...
class NodeEditor:
    ...
    def __init__(self, window, imgui_context, imgui_impl):
        ...
        if True:
            ...
            pxd_boot_img_texture = np.asarray(Image.open("src/icons/scnodes_boot_img.png")).astype(np.float32) / 255.0
    ...
    def init_node_factory():
        ...
        node_source_files = glob.glob("src/nodes/*.py")  # load all .py files in the /nodes folder
        i = 0
