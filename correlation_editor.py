...
class CorrelationEditor:
    ...
    def measure_tools(self):
        if CorrelationEditor.show_scale_bar:
            scale_bar_screen_position = self.camera.world_to_screen_position(CorrelationEditor.scale_bar_world_position)
            imgui.set_next_window_position(scale_bar_screen_position[0], scale_bar_screen_position[1])
